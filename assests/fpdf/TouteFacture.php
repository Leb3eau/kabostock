...
$koffi->Ln(20);
$koffi->SetX(30);
$koffi->Cell(150, 10, utf8_decode("FACTURE D'ACHAT"), 0, 1, "C");
...
$koffi->Cell(110, 10, utf8_decode("Article"), 1, 0, "L");
$koffi->Cell(25, 10, utf8_decode("Quantité"), 1, 0, "C");
$koffi->Cell(25, 10, "Prix", 1, 0, "C");
//$koffi->Cell(20, 10, utf8_decode("TVA"), 1, 0, "C");
$koffi->Cell(25, 10, utf8_decode("Total"), 1, 1, "C");
...
while ($row = $orderItemResult->fetch_array()) {
    ...
    $y = $koffi->GetY();
//    $koffi->MultiCell(110, 4, utf8_decode(strtoupper($row[4])."\n"." \t\t\t\tTVA : ".number_format($prix*$row[2], 2, ",", " ")." x 18% = ".number_format($prix*$row[2]*0.18, 2, ",", " ")), "LR", "L");
    $koffi->MultiCell(110, 6, utf8_decode(strtoupper($row[4])), "LR", "L");
    $koffi->SetXY(120, $y);
    $koffi->Cell(25, 5, utf8_decode($row[2]), "LR", 0, "C");
    $koffi->Cell(25, 5, number_format($prix, 2, ",", " "), "LR", 0, "C");
    //$koffi->Cell(20, 5, number_format($prix*$row[2]*0.18, 2, ",", " "), "LR", 0, "C");
    $koffi->Cell(25, 5, number_format($prix*$row[2], 2, ",", " "), "LR", 1, "C");
} // /while
// bas de page fermeture des traits du tableau
$koffi->Cell(110, 12, utf8_decode(""), "LBR", 0, "L");
$koffi->Cell(25, 12, utf8_decode(""), "LBR", 0, "C");
$koffi->Cell(25, 12, "", "LBR", 0, "C");
//$koffi->Cell(20, 12, utf8_decode(""), "LBR", 0, "C");
$koffi->Cell(25, 12, utf8_decode(""), "LBR", 1, "C");
...
$koffi->SetX(119);
$koffi->Cell(38, 5, utf8_decode("Remise"), 0, 0, "L");
$koffi->Cell(38, 5, utf8_decode(number_format($discount, 1, ",", " ")." XOF"), 0, 1, "R");

$koffi->SetX(119);
$koffi->Cell(38, 5, utf8_decode("Total à payer"), 0, 0, "L");
$koffi->Cell(38, 5, utf8_decode(number_format($grandTotal, 1, ",", " ")." XOF"), 0, 1, "R");

$koffi->SetX(119);
$koffi->Cell(38, 5, utf8_decode("Montant Payé"), 0, 0, "L");
$koffi->Cell(38, 5, utf8_decode(number_format($paid, 1, ",", " ")." XOF"), 0, 1, "R");

$koffi->SetX(119);
$koffi->Cell(38, 5, utf8_decode("Somme due"), 0, 0, "L");
$koffi->Cell(38, 5, utf8_decode(number_format($due, 1, ",", " ")." XOF"), 0, 1, "R");
...
$koffi->Output('I', 'facture-' . $code . '.pdf');
