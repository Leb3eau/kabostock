...
$sql = "SELECT produits.*, product.ratea,product.quantity,product.payment_type,product.payment_mode,product.status,fournisseurs.four_name, product.product_id, product.active FROM produits, product, fournisseurs WHERE produits.id=product.produit_id AND product.status = 1 AND fournisseurs.four_id=product.four_id ORDER BY product.product_id DESC";
